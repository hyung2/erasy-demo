 ...
 * Generated: 2026-07-09T10:41:26.135Z
 */

/**
 * ink-violet theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { inkVioletTheme } from './ink-violet';
 *   import './ink-violet.css';
 */
export const inkVioletTheme = {
  name: 'ink-violet',
  __built: true,
  tokens: {
    ...
    "--color-accent": "light-dark(#0b63f6, #4d8ffb)",
    "--color-accent-muted": "light-dark(#0b63f633, #4d8ffb3f)",
    ...
    "--color-text-accent": "light-dark(#064bb8, #7db0ff)",
    ...
    "--color-icon-accent": "light-dark(#0b63f6, #4d8ffb)",
