...
// 08-18 실데이터 전환 이후 예시 인벤토리 프로비저닝은 없다 — 배너도 그 사실을 말한다.
export const demo = {
  login: {
    eyebrow: '구글 계정 정보는 이름과 이메일만 받습니다',
    notice: '계정 발견·유출 조회·안전도 점수 모두 실제 데이터로 동작합니다',
    headline: '흩어진 계정, 한 화면에서 되찾기',
    subhead: '로그인하면 흩어진 계정을 스캔해 안전도 점수와 함께 보여드립니다.',
    google: '구글로 시작하기',
    emailLabel: '이메일',
    emailPlaceholder: 'you@example.com',
    // 로그인/가입을 여기서 가르지 않는다 — 가입 여부는 서버가 알고, 다음 화면이 갈린다.
    continueEmail: '이메일로 계속',
    back: '다른 이메일로',
    passwordTitleKnown: '가입된 이메일입니다. 비밀번호를 입력해 주세요.',
    passwordTitleNew: '처음 오셨네요. 사용할 비밀번호를 만들어 주세요.',
    googleOnly: '이 이메일은 구글 로그인으로 가입돼 있어요. 아래 버튼으로 이어서 들어오시면 됩니다.',
    passwordLabel: '비밀번호',
  ...
  scanning: {
    title: '흩어진 계정을 찾아볼까요',
    subtitle:
      '두 가지 방법으로 찾습니다. 찾는 영역이 서로 달라서, 둘 다 하시면 빠지는 계정이 줄어듭니다.',
    skip: '나중에 하고 둘러보기',
  ...
  benchmark: {
    title: '또래 대비 내 안전도',
    // 회차는 화면이 실제 점 개수로 채운다. 여기에 숫자를 적어 두면 점이 4개인 화면이
    // "최근 6회"라고 말한다(2026-08-27 실측).
    sub: '측정 시점별',
